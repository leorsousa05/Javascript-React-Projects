...
function convertNumberToDecimal(secOrMin: number) {
...
function printDate(minOrSec: Element, mtOrSc: number) {
...
start.addEventListener("click", (e) => {
    ...
    i = true;
    counter()
    start.classList.add("ativado"); start.innerHTML = 'Começou'; stoper.innerHTML = "Pausar";
})

stoper.addEventListener('click', (e) => {
    e.preventDefault()
    i = false
    start.classList.remove("ativado"); start.classList.add('desativado'); start.innerHTML = 'Começar'
...
reset.addEventListener('click', (e) => {
    ...
    start.classList.remove("ativado"); start.classList.add('desativado'); start.innerHTML = 'Começar'; stoper.innerHTML = "Pausar"
})
